...
const PATH_B: readonly [number, number][] = [
  [ 0,   4.9],  // center, entry wall
  [ 4.2, 4.9],  // right,  entry wall
  [ 4.2,-4.9],  // right,  door  wall
  [-4.2, 4.9],  // left,   entry wall
  [-4.2,-4.9],  // left,   door  wall
  [ 0,  -4.9],  // center, door  wall  → next room
]

// Same t-values as Room A (same path geometry, mirrored)
const PAUSE_ZONES: PauseZone[] = [
  { t: 0.10, audioSrc: '/Anotherexhibit.m4a' },    // right-entry corner (near Exhibit B4)
  { t: 0.34, audioSrc: '/Anotherexhibit.m4a' },  // right-door  corner (near Exhibit B3)
  { t: 0.66, audioSrc: '/Firstexhibit.m4a' },    // left-entry  corner (near Exhibit B2)
  { t: 0.90, audioSrc: '/Anotherexhibit.m4a' },  // left-door   corner (near Exhibit B1)
]
